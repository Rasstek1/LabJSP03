...
<div class="background-img">
    <div>
        <div class="container mt-5">
            ...
            <h6>Nombre de cours sélectionnés: <span
                    style="background-color: mediumseagreen; color: white; padding: 10px;"> ${panier.liste.size()}</span>
            </h6>
                        ...
                        <c:otherwise>
                            <c:forEach var="cours" items="${panier.liste}">
                                <tr class="bg-info">
                                    ...
                                    <td>${cours.session}</td>
                                    <td>
                                        <form action="${pageContext.request.contextPath}/inscription/supprimer/${cours.numero}"
                                              method="post">
            ...
            <div class="d-flex">
                <a href="${pageContext.request.contextPath}/inscription/valider" class="btn btn-primary me-2">Valider
                    mes choix</a>
